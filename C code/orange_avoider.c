...
void distance_func(int x_goal, int y_goal, double dist_func[]);
...
static void color_detection_cb(uint8_t __attribute__((unused)) sender_id,
                               ...
                               int32_t quality, uint16_t __attribute__((unused)) extra)
{
  color_count = quality;
  goal_x = pixel_width;
  goal_y = pixel_height;
...
/* Function that modifies the array dist_func to contain the distance and required rotation when given a goal (x-,y- coordinate)
 * @param x_goal - the x goal from ABI message: VISUAL_DETECTION
 * @param y_goal - the y goal from ABI message: VISUAL_DETECTION
 * @param dist_func[2] - array of size 2
 */
void distance_func(int x_goal, int y_goal, double dist_func[])
{
